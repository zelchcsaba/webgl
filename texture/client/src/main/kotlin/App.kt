...
class App(val canvas : HTMLCanvasElement, val overlay : HTMLDivElement) {
  ...
  val gl = (canvas.getContext("webgl2", object{@JsName("alpha")val alpha = false}) ?: throw Error("Browser does not support WebGL2")) as WebGL2RenderingContext //#alpha# never make canvas transparent ˙HUN˙ ne legyen áttetsző a vászon
